...
export class NotAcceptableError extends CustomError {
  constructor(
    message: string = "Not Acceptable Error",
    details: ErrorDetails = {}
  ) {
...
export class UnprocessableEntityError extends CustomError {
  constructor(
    message: string = "Unprocessable Entity Error",
    details: ErrorDetails = {}
  ) {
...
export class TooManyRequestsError extends CustomError {
  constructor(
    message: string = "Too Many Requests Error",
    details: ErrorDetails = {}
  ) {
...
export class PreconditionFailedError extends CustomError {
  constructor(
    message: string = "Precondition Failed Error",
    details: ErrorDetails = {}
  ) {
